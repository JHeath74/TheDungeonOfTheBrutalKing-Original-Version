...
public class DungeonLevel10 extends DungeonLevel {

    private static final int MAP_WIDTH = 128;
    private static final int MAP_HEIGHT = 128;
    private static final int DUNGEON_LEVEL = 10;

    public DungeonLevel10() throws IOException, InterruptedException, ParseException {
        this.map = new int[][] {
            // TODO: Replace with your own level 10 map layout
            // Example: copy and modify from DungeonLevel9
        };
        ...
        // Example special locations for level 10
        specialLocations.put(new Point(110, 127), LocationType.STAIRS_UP);
        specialLocations.put(new Point(35, 35), LocationType.STAIRS_DOWN);
    ...
    public List<? extends MapEntity> getEntities() {
        // TODO: Add entities for level 10
        return null;
    }
