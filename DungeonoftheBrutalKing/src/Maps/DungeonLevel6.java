...
public class DungeonLevel6 extends DungeonLevel {

    private static final int MAP_WIDTH = 128;
    private static final int MAP_HEIGHT = 128;
    private static final int DUNGEON_LEVEL = 6;

    public DungeonLevel6() throws IOException, InterruptedException, ParseException {
        this.map = new int[][] {
            // TODO: Replace with your own level 6 map layout
            // Example: copy and modify from DungeonLevel5
        };
        ...
        // Example special locations for level 6
        specialLocations.put(new Point(70, 120), LocationType.STAIRS_UP);
        specialLocations.put(new Point(15, 15), LocationType.STAIRS_DOWN);
