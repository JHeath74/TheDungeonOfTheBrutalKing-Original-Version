...
public class GravesongVirtuosoHarness {

    private static final Guild REQUIRED_GUILD = Guild.DIRGEWEAVERS_CHORUS;

    private static final String ARMOUR_NAME = "GravesongVirtuosoHarness";
    private static final String DESCRIPTION =
            "GravesongVirtuosoHarness: Regalia of the Dirgeweavers Chorus. Grants vitality and defense; when struck, it has a 10% chance to reflect 10% of the damage taken.";
    ...
    public static GravesongVirtuosoHarness create(Charecter character) {
        ...
        return new GravesongVirtuosoHarness();
    }
     ...
     *
     * @param damageTaken final damage actually taken
