...
private static final String WEAPON_NAME = "Nightreaper Kris";


private static final String DESCRIPTION = "Nightreaper Kris: A shadowy dagger wielded by the Crimson Veil Rogues, enhancing agility and granting a deadly critical strike chance.";


    // Store the last crit chance bonus applied for correct removal
    private double lastCritBonus = 0;

    public NightreaperKris(String effect) {
    ...
    public static NightreaperKris createBloodshadeStiletto(Charecter character, String effect) {
        ...
        if (character.getAgility() >= REQUIRED_AGILITY) {
            return new NightreaperKris(effect);
        }
