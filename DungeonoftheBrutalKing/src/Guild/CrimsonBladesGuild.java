...
public class CrimsonBladesGuild extends JPanel {
    private boolean isMember;
    private final boolean isEvil = true; // Designates this guild as evil

    public CrimsonBladesGuild(boolean isMember) {
        this.isMember = isMember;
        setLayout(new BorderLayout());

        // Add an image to the panel
        JLabel imageLabel = new JLabel(new ImageIcon(getClass().getResource("/DungeonoftheBrutalKing/Images/CrimsonBladesGuild.jpg")));
        ...
        if (!isMember) {
            ...
            joinGuildButton.addActionListener(e -> {
                this.isMember = true;
                JOptionPane.showMessageDialog(this, "You have joined the Crimson Blades Guild!");
                reloadPanel();
            });
    ...
    private void reloadPanel() {
        ...
        revalidate();
        repaint();
        new CrimsonBladesGuild(isMember);
    }
