...
public class DawnwardPaladins extends JPanel {
    ...
    private void buyGuildSpell() {
        ...
        DawnwardPaladinsGuildSpellsManager manager = new DawnwardPaladinsGuildSpellsManager(Guild.DAWNWARD_PALADINS);
        ...
        list.addListSelectionListener(ev -> {
            ...
            Spell s = SpellFactory.createGuildSpell(sel, Guild.DAWNWARD_PALADINS);
            if (s != null) {
