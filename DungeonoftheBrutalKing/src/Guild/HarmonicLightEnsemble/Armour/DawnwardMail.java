...
public class DawnwardMail {
    ...
    private static final String DESCRIPTION =
            "HarmonicLightResonantVestments: Light, layered performance vestments reserved for the Harmonic Light Ensemble. " +
            "Grants defense and bolsters charisma and vitality for inspiring songs and steady breath.";
    ...
    public static DawnwardMail createHarmonicLightResonantVestments(Charecter character) {
        ...
        if (character.getVitality() < REQUIRED_VITALITY)
            throw new IllegalArgumentException("Character does not have the required vitality to wear the HarmonicLightResonantVestments.");
        if (character.getCharisma() < REQUIRED_CHARISMA)
            throw new IllegalArgumentException("Character does not have the required charisma to wear the HarmonicLightResonantVestments.");
