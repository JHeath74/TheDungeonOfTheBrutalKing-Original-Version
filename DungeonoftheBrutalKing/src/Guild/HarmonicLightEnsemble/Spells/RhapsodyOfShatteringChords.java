...
public class RhapsodyOfShatteringChords implements Spell {

    private static final String NAME = "Rhapsody of Shattering Chords";
    ...
    private static final StatusType ON_HIT_STATUS = StatusType.DRAIN_STATUS;
