...
public class Necromancer extends Enemies {
    ...
    public Necromancer(int level, int strength, int charisma, int agility, int intelligence, int wisdom, int vitality, int spellStrength) {
        super(
            ...
            intelligence,
            wisdom,
            GameSettings.getMonsterImagePath() + "Necromancer.png",
            true,
            vitality
        );
        this.level = level;
    ...
    public int attack(Character target, MainGameScreen mainGameScreen) {
        ...
        MainGameScreen.appendToMessageTextPane(getName() + " casts a necrotic spell for " + damage + " damage!" + (critical ? " Critical hit!" : ""));
        return damage;
    }
    ...
    public String getImagePath() {
        if (getHitPoints() < 12) {
            return GameSettings.getMonsterImagePath() + "Necromancer_injured.png";
        }
    ...
    private static int randomLevel() {
        return 7 + RandomFactory.gameplayInt(2);
    }
