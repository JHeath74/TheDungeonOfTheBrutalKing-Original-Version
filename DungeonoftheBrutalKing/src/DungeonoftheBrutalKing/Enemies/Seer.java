...
// src/DungeonoftheBrutalKing/Enemies/Seer.java
...
public class Seer extends Enemies {
    ...
    public Seer() {
        this(randomLevel(), 4, 11, 6, 14, 14, 6);
    }

    public Seer(int level, int strength, int charisma, int agility, int intelligence, int wisdom, int vitality) {
        super(
            "Seer",
            level,
            (level * 5) + (vitality * 7),
