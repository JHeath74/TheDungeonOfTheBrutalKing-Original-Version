...
public class Troll extends Enemies {
    ...
    public Troll(int level, int strength, int charisma, int agility, int intelligence, int wisdom, int vitality) {
        super(
            ...
            intelligence,
            wisdom,
            GameSettings.getMonsterImagePath() + "Troll.png",
            false,
            vitality
        );
        this.level = level;
    ...
    public int attack(Character target, MainGameScreen mainGameScreen) {
        ...
        MainGameScreen.appendToMessageTextPane(getName() + " smashes for " + damage + " damage!" + (critical ? " Critical hit!" : ""));
        return damage;
    }
    ...
    public String getImagePath() {
        if (getHitPoints() < 10) {
            return GameSettings.getMonsterImagePath() + "Troll_injured.png";
        }
