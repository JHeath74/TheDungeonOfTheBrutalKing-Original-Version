...
public class Crossbow extends WeaponManager {
    ...
    public Crossbow(int damage, String effect) {
        super("Crossbow", REQUIRED_STRENGTH, damage, effect, DEFAULT_WEIGHT);
    }

    public Crossbow(int requiredStrength, int damage, String effect) {
        super("Crossbow", requiredStrength, damage, effect, DEFAULT_WEIGHT);
    }

    public static Crossbow createCrossbow(Character character, int damage, String effect) {
