...
// `src/Guild/NightShadeHunters/Spells/SilencingBolt.java`
...
public class SilencingBolt implements Spell {

    private static final String NAME = "Silencing Bolt";
    private static final String DESCRIPTION =
            "A shadow-tipped bolt that disrupts focus. Silences the target for a short duration.";
    ...
    private static final StatusType DEBUFF_STATUS = StatusType.DAZE_STATUS;
    private static final int DEBUFF_DURATION_TURNS = 2;
    private static final int DEBUFF_VALUE = 1;
