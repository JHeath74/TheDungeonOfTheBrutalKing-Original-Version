...
public class MysticRainment extends ArmourManager {
    ...
    private static final int ARMOUR_DEFENSE = 2; // base defence for this armour
    ...
    public MysticRainment(Set<String> resistanceTypes, String effect) {
        ...
        super("Mystic Raiment", 0, ARMOUR_DEFENSE, WEIGHT, effect);
    ...
    public String getDescription() {
        return "Mystic Raiment: A cloak woven from shadow, starlight, or elemental threads. "
             + "Provides concealment and resistance to certain damage types.";
    }
}
