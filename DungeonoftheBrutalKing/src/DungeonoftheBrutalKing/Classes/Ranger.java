...
/**
 * Represents the Ranger class in the game.
 * <p>
 * Rangers are masters of the wilderness, skilled in tracking, survival, and ranged combat.
 * They excel at striking from afar, setting traps, and adapting to any environment.
...
public class Ranger extends Class {
    ...
    public static final String CHAR_CLASS = "Ranger";
    private static final String IMAGE = "/images/Ranger.webp";
    ...
    /**
     * Returns the full resource path for the Ranger image.
     */
    @Override
    ...
    /**
     * Returns whether the Ranger is a magic user.
     * @return false, as Rangers are not magic users.
     */
    @Override
    ...
    /** @return the primary stat for Ranger */
    @Override
    public Stat getPrimaryStat() { return PRIMARY_STAT; }

    /** @return the secondary stat for Ranger */
    @Override
