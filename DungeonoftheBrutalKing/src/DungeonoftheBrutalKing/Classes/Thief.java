...
/**
 * Represents the Thief class in the game.
 * <p>
 * Thieves are masters of stealth, deception, and precision. Skilled in infiltration, lockpicking, and striking from the shadows,
 * they excel at bypassing defenses and exploiting enemy weaknesses. Their agility allows them to move swiftly and avoid danger,
...
public class Thief extends Class {
    ...
    private static final String IMAGE = "/images/Thief.webp";
    ...
    /**
     * Returns the full resource path for the Thief image.
     */
    @Override
    ...
    /**
     * Returns whether the Thief is a magic user.
     * @return false, as Thieves are not magic users.
     */
    @Override
    ...
    /** @return the primary stat for Thief */
    @Override
    public Stat getPrimaryStat() { return PRIMARY_STAT; }

    /** @return the secondary stat for Thief */
    @Override
