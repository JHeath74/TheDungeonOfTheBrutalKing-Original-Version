...
/**
 * Represents the Warrior class in the game.
 * <p>
 * Warriors are battle-hardened champions, excelling in the art of combat and mastery of weapons and armor.
 * They lead the charge, withstand devastating blows, and inspire allies through sheer strength and resilience.
 * Their strength empowers their attacks, while their stamina allows them to endure the harshest battles,
 * making them formidable opponents and stalwart defenders.
 */
public class Warrior extends Class {
    ...
    private static final String IMAGE = "/images/Warrior.png";
    ...
    /**
     * Returns the full resource path for the Warrior image.
     */
    @Override
    ...
    /**
     * Returns whether the Warrior is a magic user.
     * @return false, as Warriors are not magic users.
     */
    @Override
    ...
    /** @return the primary stat for Warrior */
    @Override
    public Stat getPrimaryStat() { return PRIMARY_STAT; }

    /** @return the secondary stat for Warrior */
    @Override
