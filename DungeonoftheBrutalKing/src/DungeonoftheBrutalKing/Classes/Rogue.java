...
/**
 * Represents the Rogue class in the game.
 * <p>
 * Rogues are masters of stealth, deception, and precision. Skilled in infiltration, lockpicking, and striking from the shadows,
...
public class Rogue extends Class {
    ...
    private static final String IMAGE = "/images/Rogue.png";
    ...
    /**
     * Returns the full resource path for the Rogue image.
     */
    @Override
    ...
    /**
     * Returns whether the Rogue is a magic user.
     * @return false, as Rogues are not magic users.
     */
    @Override
    ...
    /** @return the primary stat for Rogue */
    @Override
    public Stat getPrimaryStat() { return PRIMARY_STAT; }

    /** @return the secondary stat for Rogue */
    @Override
