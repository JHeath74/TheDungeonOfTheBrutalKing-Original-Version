...
import DungeonoftheBrutalKing.MainGameScreen.GamePanel;
...
//MainGameScreen.GamePanel myGamePanel = myMainGameScreen.new GamePanel();
...
private MainGameScreen GamePanel;
private static Game instance;

private Game(MainGameScreen GamePanel) throws IOException {
...
public static Game getInstance(MainGameScreen gamePanel) throws IOException {
    if (instance == null) {
        synchronized (Game.class) {
            if (instance == null) {
                instance = new Game(gamePanel);
            }
        }
    }
    return instance;
...
//	BufferStrategy bs = myMainGameScreen.getBufferStrategy();
	//if(bs == null) {
	//	myMainGameScreen.createBufferStrategy(3);
	//	return;
	//}
...
if (GamePanel != null)
{ 
	GamePanel.getGamePanel().setImage(image); // Set the image in GameImagesAndCombatPanel } }
}
}
    //}
