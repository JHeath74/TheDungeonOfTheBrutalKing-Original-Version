...
/**
 * Represents a Spider enemy with poison attack and alignment.
 */
public class Spider extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Spider enemy with predefined stats and image.
     */
    public Spider() {
        super(
            "Spider",                                   // Name
            ...
            6,                                          // Intelligence
            3,                                          // Wisdom
            GameSettings.MonsterImagePath + "Spider.png", // Image path
            false,                                      // Is magic user
            0                                           // Spell strength
        );
     ...
     * Prints a message if the Spider dies.
    ...
    /**
     * Checks if the Spider is dead (hit points <= 0).
    ...
    /**
     * Calculates the Spider's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Spider.
    ...
    /**
     * Returns a string representation of the Spider's stats.
    ...
    /**
     * Gets the experience reward for defeating the Spider.
    ...
    /**
     * Gets the gold reward for defeating the Spider.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Spider.
     * @return alignment.
     */
