...
/**
 * Represents a Master Thief enemy with combat abilities and alignment.
 */
public class Master_Thief extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Master Thief enemy with predefined stats and image.
     */
    public Master_Thief() {
        super(
            "Master Thief",                              // Name
            ...
            6,                                           // Intelligence
            3,                                           // Wisdom
            GameSettings.MonsterImagePath + "Master_Thief.png", // Image path
            false,                                       // Is magic user
            0                                            // Spell strength
        );
     ...
     * Prints a message if the Master Thief dies.
    ...
    /**
     * Checks if the Master Thief is dead (hit points <= 0).
    ...
    /**
     * Calculates the Master Thief's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Master Thief.
    ...
    /**
     * Returns a string representation of the Master Thief's stats.
    ...
    /**
     * Gets the level of the Master Thief.
     * @return the level.
     */
    public int getLevel() {
        return level;
    ...
    /**
     * Gets the experience reward for defeating the Master Thief.
    ...
    /**
     * Gets the gold reward for defeating the Master Thief.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Master Thief.
     * @return alignment.
     */
