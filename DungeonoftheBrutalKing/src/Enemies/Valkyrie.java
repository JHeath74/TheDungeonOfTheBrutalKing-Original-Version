...
/**
 * Represents a Valkyrie enemy with basic combat abilities and alignment.
 */
public class Valkyrie extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Valkyrie enemy with predefined stats and image.
     */
    public Valkyrie() {
        super(
            "Valkyrie",                                   // Name
            ...
            6,                                            // Intelligence
            3,                                            // Wisdom
            GameSettings.MonsterImagePath + "Valkyrie.png", // Image path
            false,                                        // Is magic user
            0                                             // Spell strength
        );
     ...
     * Prints a message if the Valkyrie dies.
    ...
    /**
     * Checks if the Valkyrie is dead (hit points <= 0).
    ...
    /**
     * Calculates the Valkyrie's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Valkyrie.
    ...
    /**
     * Returns a string representation of the Valkyrie's stats.
    ...
    /**
     * Gets the level of the Valkyrie.
     * @return the level.
     */
    public int getLevel() {
        return level;
    ...
    /**
     * Gets the experience reward for defeating the Valkyrie.
    ...
    /**
     * Gets the gold reward for defeating the Valkyrie.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Valkyrie.
     * @return alignment.
     */
    @Override
