...
public class Valkyrie extends Enemies {
    ...
    public Valkyrie() {
        super(
            /* name: The type or identifier of the enemy */ "Valkyrie",
            ...
            /* imagePath: Path to the enemy's image asset */ GameSettings.MonsterImagePath + "Valkyrie.png",
            /* isMagicUser: Valkyrie is not a magic user */ false,
            /* spellStrength: Valkyrie has no spell strength */ 0
        );
        this.level = 5;
    }
