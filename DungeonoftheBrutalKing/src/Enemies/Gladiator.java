...
/**
 * Represents a Gladiator enemy with basic combat abilities and alignment.
 */
public class Gladiator extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Gladiator enemy with predefined stats and image.
     */
    public Gladiator() {
        super(
            "Gladiator",                          // Name
            ...
            6,                                    // Intelligence
            3,                                    // Wisdom
            GameSettings.MonsterImagePath + "Gladiator.png", // Image path
            false,                                // Is magic user
            0                                     // Spell strength
        );
     ...
     * Prints a message if the Gladiator dies.
    ...
    /**
     * Checks if the Gladiator is dead (hit points <= 0).
    ...
    /**
     * Calculates the Gladiator's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Gladiator.
    ...
    /**
     * Returns a string representation of the Gladiator's stats.
    ...
    /**
     * Gets the level of the Gladiator.
     * @return the level.
     */
    public int getLevel() {
        return level;
    ...
    /**
     * Gets the experience reward for defeating the Gladiator.
    ...
    /**
     * Gets the gold reward for defeating the Gladiator.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Gladiator.
     * @return alignment.
     */
