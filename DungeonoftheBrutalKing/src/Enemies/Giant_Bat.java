...
/**
 * Represents a Giant Bat enemy with basic combat abilities and alignment.
 */
public class Giant_Bat extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Giant Bat enemy with predefined stats and image.
     */
    public Giant_Bat() {
        super(
            "Giant Bat",                          // Name
            ...
            6,                                    // Intelligence
            3,                                    // Wisdom
            GameSettings.MonsterImagePath + "Giant Bat.png", // Image path
            false,                                // Is magic user
            0                                     // Spell strength
        );
     ...
     * Prints a message if the Giant Bat dies.
    ...
    /**
     * Checks if the Giant Bat is dead (hit points <= 0).
    ...
    /**
     * Calculates the Giant Bat's attack damage based on strength and agility.
     ...
     * Caps reduction at 60%. Displays a message with the reduced damage.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Giant Bat.
    ...
    /**
     * Returns a string representation of the Giant Bat's stats.
    ...
    /**
     * Gets the level of the Giant Bat.
     * @return the level.
     */
    public int getLevel() {
        return level;
    ...
    /**
     * Gets the experience reward for defeating the Giant Bat.
    ...
    /**
     * Gets the gold reward for defeating the Giant Bat.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Giant Bat.
     * @return alignment.
     */
