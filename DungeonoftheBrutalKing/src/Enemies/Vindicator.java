...
/**
 * Represents a Vindicator enemy with good alignment and no magic abilities.
 */
public class Vindicator extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Creates a Vindicator enemy with specific stats and good alignment.
     * Sets name, level, hit points, attributes, image path, magic user status, and spell strength.
     */
    public Vindicator() {
        super(
            "Vindicator",       // Enemy name
            8,                  // Level
            53,                 // Hit points
            9,                  // Strength
            8,                  // Charisma
            ...
            7,                  // Intelligence
            9,                  // Wisdom
            GameSettings.MonsterImagePath + "Vindicator.png", // Image path
            false,              // Is magic user
            0                   // Spell strength
        );
