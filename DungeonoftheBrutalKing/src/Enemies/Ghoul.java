...
/**
 * Represents a Ghoul enemy with basic combat abilities and alignment.
 */
public class Ghoul extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Ghoul enemy with predefined stats and image.
     */
    public Ghoul() {
        super(
            "Ghoul",                          // Name
            ...
            6,                                // Intelligence
            3,                                // Wisdom
            GameSettings.MonsterImagePath + "Ghoul.png", // Image path
            false,                            // Is magic user
            0                                 // Spell strength
        );
     ...
     * Prints a message if the Ghoul dies.
    ...
    /**
     * Checks if the Ghoul is dead (hit points <= 0).
    ...
    /**
     * Calculates the Ghoul's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Ghoul.
    ...
    /**
     * Returns a string representation of the Ghoul's stats.
    ...
    /**
     * Gets the experience reward for defeating the Ghoul.
    ...
    /**
     * Gets the gold reward for defeating the Ghoul.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Ghoul.
     * @return alignment.
     */
