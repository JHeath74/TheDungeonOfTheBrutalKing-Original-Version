...
/**
 * Represents a Custodian enemy with good alignment and no magic abilities.
 */
public class Custodian extends Enemies {
    ...
    public Custodian() {
        super(
            ...
            9,                  // Intelligence
            8,                  // Wisdom
            GameSettings.MonsterImagePath + "Custodian.png", // Image path
            false,              // Is magic user
            0                   // Spell strength
        );
