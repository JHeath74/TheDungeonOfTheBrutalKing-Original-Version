...
/**
 * Represents a Sentinel enemy with good alignment and no magic abilities.
 */
public class Sentinel extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Creates a Sentinel enemy with specific stats and good alignment.
    ...
    public Sentinel() {
        super(
            ...
            7,                  // Intelligence
            9,                  // Wisdom
            GameSettings.MonsterImagePath + "Sentinel.png", // Image path
            false,              // Is magic user
            0                   // Spell strength
        );
    ...
    @Override
    public int attack() {
        return (int) ((getStrength() * 1.4) + (getWisdom() * 1.3));
    }
