...
/**
 * Represents a Templar enemy with good alignment and no magic abilities.
 */
public class Templar extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Creates a Templar enemy with specific stats and good alignment.
    ...
    public Templar() {
        super(
            ...
            7,                  // Intelligence
            8,                  // Wisdom
            GameSettings.MonsterImagePath + "Templar.png", // Image path
            false,              // Is magic user
            0                   // Spell strength
        );
