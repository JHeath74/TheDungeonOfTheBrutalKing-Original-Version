...
/**
 * Represents a Horned Devil enemy with basic combat abilities and alignment.
 */
public class Horned_Devil extends Enemies {
    ...
    private final int alignmentImpact = 3; // Impact on player's alignment when defeated;

    // --- Constructor ---
    /**
     * Constructs a Horned Devil enemy with predefined stats and image.
     */
    public Horned_Devil() {
        super(
            "Horned Devil",                          // Name
            ...
            6,                                       // Intelligence
            3,                                       // Wisdom
            GameSettings.MonsterImagePath + "Horned_Devil.png", // Image path
            false,                                   // Is magic user
            0                                        // Spell strength
        );
     ...
     * Prints a message if the Horned Devil dies.
    ...
    /**
     * Checks if the Horned Devil is dead (hit points <= 0).
    ...
    /**
     * Calculates the Horned Devil's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Horned Devil.
    ...
    /**
     * Returns a string representation of the Horned Devil's stats.
    ...
    /**
     * Gets the level of the Horned Devil.
     * @return the level.
     */
    public int getLevel() {
        return level;
    ...
    /**
     * Gets the experience reward for defeating the Horned Devil.
    ...
    /**
     * Gets the gold reward for defeating the Horned Devil.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Horned Devil.
     * @return alignment.
     */
