...
/**
 * Represents a Gnoll enemy with basic combat abilities and alignment.
 */
public class Gnoll extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Gnoll enemy with predefined stats and image.
     */
    public Gnoll() {
        super(
            "Gnoll",                          // Name
            ...
            6,                                // Intelligence
            3,                                // Wisdom
            GameSettings.MonsterImagePath + "Gnoll.png", // Image path
            false,                            // Is magic user
            0                                 // Spell strength
        );
     ...
     * Prints a message if the Gnoll dies.
    ...
    /**
     * Checks if the Gnoll is dead (hit points <= 0).
    ...
    /**
     * Calculates the Gnoll's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Gnoll.
    ...
    /**
     * Returns a string representation of the Gnoll's stats.
    ...
    /**
     * Gets the experience reward for defeating the Gnoll.
    ...
    /**
     * Gets the gold reward for defeating the Gnoll.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Gnoll.
     * @return alignment.
     */
