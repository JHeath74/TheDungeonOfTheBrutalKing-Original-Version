...
public class Troll extends Enemies {
    ...
    public Troll() {
        super(
            /* name: The type or identifier of the enemy */ "Troll",
            ...
            /* imagePath: Path to the enemy's image asset */ GameSettings.MonsterImagePath + "Troll.png",
            /* isMagicUser: Troll is not a magic user */ false,
            /* spellStrength: Troll has no spell strength */ 0
        );
        this.level = 7;
    }
