...
/**
 * Represents a Troll enemy with basic combat abilities and alignment.
 */
public class Troll extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Troll enemy with predefined stats and image.
     */
    public Troll() {
        super(
            "Troll",                                   // Name
            ...
            6,                                         // Intelligence
            3,                                         // Wisdom
            GameSettings.MonsterImagePath + "Troll.png", // Image path
            false,                                     // Is magic user
            0                                          // Spell strength
        );
     ...
     * Prints a message if the Troll dies.
    ...
    /**
     * Checks if the Troll is dead (hit points <= 0).
    ...
    /**
     * Calculates the Troll's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Troll.
    ...
    /**
     * Returns a string representation of the Troll's stats.
    ...
    /**
     * Gets the experience reward for defeating the Troll.
    ...
    /**
     * Gets the gold reward for defeating the Troll.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Troll.
     * @return alignment.
     */
    @Override
