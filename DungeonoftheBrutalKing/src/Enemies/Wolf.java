...
/**
 * Represents a Wolf enemy with basic combat abilities and alignment.
 */
public class Wolf extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Wolf enemy with predefined stats and image.
     */
    public Wolf() {
        super(
            "Wolf",                                   // Name
            ...
            6,                                        // Intelligence
            3,                                        // Wisdom
            GameSettings.MonsterImagePath + "Wolf.png", // Image path
            false,                                    // Is magic user
            0                                         // Spell strength
        );
     ...
     * Prints a message if the Wolf dies.
    ...
    /**
     * Checks if the Wolf is dead (hit points <= 0).
    ...
    /**
     * Calculates the Wolf's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Wolf.
    ...
    /**
     * Returns a string representation of the Wolf's stats.
    ...
    /**
     * Gets the experience reward for defeating the Wolf.
    ...
    /**
     * Gets the gold reward for defeating the Wolf.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Wolf.
     * @return alignment.
     */
    @Override
