...
/**
 * Represents a Protector enemy with good alignment and no magic abilities.
 */
public class Protector extends Enemies {
    ...
    public Protector() {
        super(
            ...
            7,                  // Intelligence
            9,                  // Wisdom
            GameSettings.MonsterImagePath + "Protector.png", // Image path
            false,              // Is magic user
            0                   // Spell strength
        );
    ...
    @Override
    public int attack() {
        return (int) ((getStrength() * 1.4) + (getWisdom() * 1.2));
    }
