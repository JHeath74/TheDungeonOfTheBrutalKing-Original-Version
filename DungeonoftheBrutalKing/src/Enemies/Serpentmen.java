...
/**
 * Represents a Serpentmen enemy with combat abilities and alignment.
 */
public class Serpentmen extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Serpentmen enemy with predefined stats and image.
     */
    public Serpentmen() {
        super(
            "Serpentmen",                                   // Name
            ...
            6,                                              // Intelligence
            3,                                              // Wisdom
            GameSettings.MonsterImagePath + "Serpentmen.png", // Image path
            false,                                          // Is magic user
            0                                               // Spell strength
        );
     ...
     * Prints a message if the Serpentmen dies.
    ...
    /**
     * Checks if the Serpentmen is dead (hit points <= 0).
    ...
    /**
     * Calculates the Serpentmen's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Serpentmen.
    ...
    /**
     * Returns a string representation of the Serpentmen's stats.
    ...
    /**
     * Gets the level of the Serpentmen.
     * @return the level.
     */
    public int getLevel() {
        return level;
    ...
    /**
     * Gets the experience reward for defeating the Serpentmen.
    ...
    /**
     * Gets the gold reward for defeating the Serpentmen.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Serpentmen.
     * @return alignment.
     */
