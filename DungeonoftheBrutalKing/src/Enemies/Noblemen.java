...
public class Noblemen extends Enemies {
    ...
    public Noblemen() {
        super(
            /* name: The type or identifier of the enemy */ "Noblemen",
            ...
            /* imagePath: Path to the enemy's image asset */ GameSettings.MonsterImagePath + "Noblemen.png",
            /* isMagicUser: Noblemen is not a magic user */ false,
            /* spellStrength: Noblemen has no spell strength */ 0
        );
        this.level = 4;
    }
