...
/**
 * Represents a Noblemen enemy with combat abilities and alignment.
 */
public class Noblemen extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Noblemen enemy with predefined stats and image.
     */
    public Noblemen() {
        super(
            "Noblemen",                                   // Name
            ...
            6,                                            // Intelligence
            3,                                            // Wisdom
            GameSettings.MonsterImagePath + "Noblemen.png", // Image path
            false,                                        // Is magic user
            0                                             // Spell strength
        );
     ...
     * Prints a message if the Noblemen dies.
    ...
    /**
     * Checks if the Noblemen is dead (hit points <= 0).
    ...
    /**
     * Calculates the Noblemen's attack damage based on strength and agility.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Noblemen.
    ...
    /**
     * Returns a string representation of the Noblemen's stats.
    ...
    /**
     * Gets the level of the Noblemen.
     * @return the level.
     */
    public int getLevel() {
        return level;
    ...
    /**
     * Gets the experience reward for defeating the Noblemen.
    ...
    /**
     * Gets the gold reward for defeating the Noblemen.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Noblemen.
     * @return alignment.
     */
