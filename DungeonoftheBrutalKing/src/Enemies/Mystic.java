...
/**
 * Represents a Mystic enemy with good alignment and magic abilities.
 */
public class Mystic extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Creates a Mystic enemy with specific stats and good alignment.
    ...
    public Mystic() {
        super(
            ...
            9,                  // Intelligence
            10,                 // Wisdom
            GameSettings.MonsterImagePath + "Mystic.png", // Image path
            true,               // Is magic user
            15                  // Spell strength
        );
    ...
    public void takeDamage(int damage) {
        ...
        if (isDead()) MainGameScreen.appendToMessageTextPane(getName() + " fades, but mystic energy lingers.");
    }
    ...
    public int defend(int incomingDamage) {
        ...
        MainGameScreen.appendToMessageTextPane(getName() + " conjures a mystic shield, reducing damage to " + reducedDamage + ".");
