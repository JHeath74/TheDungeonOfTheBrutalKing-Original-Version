...
/**
 * Represents a Wraith enemy with magical combat abilities and alignment.
 */
public class Wraith extends Enemies {
    ...
    // --- Constructor ---
    /**
     * Constructs a Wraith enemy with predefined stats and image.
     */
    public Wraith() {
        super(
            "Wraith",                                   // Name
            ...
            8,                                          // Intelligence
            4,                                          // Wisdom
            GameSettings.MonsterImagePath + "Wraith.png", // Image path
            true,                                       // Is magic user
            5                                           // Spell strength
        );
     ...
     * Prints a message if the Wraith dies.
    ...
    /**
     * Checks if the Wraith is dead (hit points <= 0).
    ...
    /**
     * Calculates the Wraith's attack damage based on intelligence, charisma, and spell strength.
    ...
    // --- Utility Methods ---
    /**
     * Returns the image path for the Wraith.
    ...
    /**
     * Returns a string representation of the Wraith's stats.
    ...
    /**
     * Gets the experience reward for defeating the Wraith.
    ...
    /**
     * Gets the gold reward for defeating the Wraith.
     * @return gold amount.
     */
    @Override
    ...
    /**
     * Gets the alignment of the Wraith.
     * @return alignment.
     */
    @Override
